...
class JinjaCommand():
    ...
    def __init__(self, args):
        try:
            ...
            JinjaTemplate(args.values, args.environment_type)(args.template, args.output)
        except Exception:
    ...
    def create_parser_in(parent_parser):
        ...
        parser.add_argument("--output", "-o", required=False, type=str, default="yaml", choices=["yaml", "json"],
                                help="Format of the output. Either yaml or json")
        parser.add_argument("--env-prefix", "-p", required=False, type=str, default="AWS_ENV_VARS_",
